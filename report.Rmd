...
percentageOfAngioplastyCoronary <- round(angioplastyCoronaryNumber / totalNumSurgery * 100, 2)
percentageOfAngioplastyValv <- round(angioplastyValvNumber / totalNumSurgery * 100, 2)
percentageOfAngioplastySCA <- round(angioplastySCANumber / totalNumSurgery * 100, 2)
percentageOfAngioplastyOther <- round(angioplastyOther / totalNumSurgery * 100, 2)
...
#Pie angioplasty
progsAngioplasty <- c("Prog valv", "Prog coronaria", "SCA no SST","Other")
...
#Pie surgery
progsSurgery <- c("Prog coronaria", "Prog valv", "Other")
